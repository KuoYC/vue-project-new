<template>
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item">修改選單內容</li>
        </ul>
                            ...
                            <section class="mail-list">
                                <div class="mail-sender">
                                        ...
                                        <h4 class="vew-mail-header">
                                            <div class="author-box-name d-flex justify-content-between"
                                                ...
                                                <h4><input type="text" class="form-control"
                                                           v-model="sourceData.souTitle" placeholder="標題"/></h4>
                                            </div>
                                            <hr>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="col-6" style="padding-bottom: 20px;">
                                        <button type="button" @click="updateSource"
    ...
    export default {
        ...
        methods: {
            ...
            updateSource() {
                ...
                console.log(payload);
                this.$api
                    .put(this.$test ? '/api/?type=source' : '/api/iform/source', payload)
                    .then(response => {
                        console.log(response.data);
                        if (response.status === 200) {
                            this.$router.push(`/info/source/sl/${this.sourceData.souId}`);
                        } else {
                            console.log('err');
                        }
