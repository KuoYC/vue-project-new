<template>
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item">修改公告</li>
        </ul>
                                    ...
                                    <div class="mail-heading">
                                        <h4 class="vew-mail-header">
                                            <div class="author-box-name d-flex justify-content-between" style="margin-bottom: 20px;">
                                                <h4 class="col-12"><input type="text" class="form-control" v-model="newsData.nwsTitle" placeholder="公告標題"/></h4>
                                            </div>
                                            <hr>
                                        </h4>
                                    </div>
                                    <div class="col-6" style="padding-bottom: 20px;">
                                        <button type="button" @click="updateNews"
                                                :disabled="'' === newsData.nwsTitle"
    ...
    export default {
        ...
        methods: {
            ...
            updateNews(){
                ...
                console.log(payload);
                this.$api
                    .put(this.$test ? '/api/?type=news' : '/api/iform/news', payload)
                    .then(response => {
                        console.log(response.data);
                        if (response.status === 200) {
                            console.log('ok');
                            this.$router.push(`/info/news/sl/${this.newsData.nwsId}`);
                        } else {
                            console.log('err');
                        }
