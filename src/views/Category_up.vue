                                ...
                                <div class="mail-sender">
                                    ...
                                    <div class="col-6" style="padding-bottom: 20px;">
                                        <button type="button" @click="updateCategory"
                                                :disabled="'' === categoryData.catTitle || ('word' === categoryData.catType && '' === categoryData.catWord)"
    ...
    export default {
        ...
        methods: {
            ...
            updateCategory(){
                ...
                console.log(payload);
                this.$api
                    .put(this.$test ? '/api/?type=category' : '/api/iform/category', payload)
                    .then(response => {
                        console.log(response.data);
                        if (response.status === 200) {
                            console.log('ok');
                            this.$router.push(`/info/category/sl/${this.categoryData.catId}`);
                        } else {
                            console.log('err');
                        }
