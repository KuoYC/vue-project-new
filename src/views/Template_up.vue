                                                        ...
                                                        <div class="author-box-name d-flex justify-content-between"
                                                            ...
                                                            <div v-if="parentIndex === 0">
                                                                ...
                                                                <div class="myFont16" style="font-weight: 400;">
                                                                    生效日期：<span
                                                                        class="date float-end"
                                                                        style="font-style: italic; color: #e3e3e3;">簽核完成後產生</span>
                                                                </div>
                                                                <!-- 這裡放計劃框架 -->
                                                                <div class="myFont16" style="font-weight: 400;">
                                                                    計劃框架：<span
                                                                    ...
                                                                    <template v-if="element.type === 'subject'">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <div class="myFont16">管理維運公司：<span
                                                                                    class="data"
                                                                                    style="font-style: italic; color: #e3e3e3;">依發起人公司顯示</span>
                                                                            </div>
                                                                            <!-- 這裡放承辦單位 -->
                                                                            <div class="myFont16">承辦單位：<span
                                                                                    class="date"
                                                                                    style="font-style: italic; color: #e3e3e3;">依發起人單位顯示</span></div>
                                                                            <!-- 這裡放承辦人 -->
                                                                            <div class="myFont16">承辦人：<span
                                                                                    class="data"
                                                                                    style="font-style: italic; color: #e3e3e3;">依發起人顯示</span></div>
                                                                            <!-- 這裡放聯絡電話 -->
                                                                            <div class="myFont16">聯絡電話：<span
                                                                                    class="data"
                                                                                    style="font-style: italic; color: #e3e3e3;">依發起人顯示</span>
                                                                            </div>
                                                                            <!-- 這裡放使用公司 -->
